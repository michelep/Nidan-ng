...
?>
	...
	<!-- Modal -->
	<div class="modal fade" id="popup-dialog" tabindex="-1" role="dialog" aria-labelledby="modal-dialog-title" aria-hidden="true">
	...
	<div class="container">
	    <span class="text-muted">Nidan-ng - Made with &#9829; in Siena</span>
	</div>
    </footer>
